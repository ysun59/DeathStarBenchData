...
Overall cpu utilization comparison,under the condition: t_10_c_30_frontCore_4_wrk_1, different -R, according to the data in the upper excel [02 - Latency of MediaMicroservices](https://docs.google.com/spreadsheets/d/1KipZ43JScKEp5h5mVUZfuVkJqZ-6gj9VnuggwYaOQyM/edit#gid=0)

![CPU_Utilization](CPU_Utilization_media.png)

## Avg Latency
Avg Latency comparison,under the condition: t_10_c_30_frontCore_4_wrk_1, firrerent -R, according to the data in the upper excel [02 - Latency of MediaMicroservices](https://docs.google.com/spreadsheets/d/1KipZ43JScKEp5h5mVUZfuVkJqZ-6gj9VnuggwYaOQyM/edit#gid=0)

![Avg_Latency](Avg_Latency_media.jpg)

## Mpstat-UsrSysEtc
The mpstat result,under the condition: t_10_c_30_frontCore_4_wrk_1, -R 600, compare the UsrSysEtc result of "container set" and "firecracker set"

![Mpstat_UsrSysEtc_R800](mpstat_UsrSysEtc-containerSet-firecrackerSet-R-600.jpg)
