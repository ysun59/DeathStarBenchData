...
cp dealCon.sh Res-container-random-Swarm-v1-machine2
cp dealCon.sh Res-container-set-Swarm-v1-machine2
cp dealFire.sh Res-firecracker-random-Swarm-v1-machine2
cp dealFire.sh Res-firecracker-set-Swarm-v1-machine2
