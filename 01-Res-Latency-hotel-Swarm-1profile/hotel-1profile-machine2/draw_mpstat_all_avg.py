...
def mpstatAllAvg(n):
  ...
  filenames = ['Res-container-random-Swarm-v1-machine2/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-container-set-Swarm-v1-machine2/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-firecracker-random-Swarm-v1-machine2/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-firecracker-set-Swarm-v1-machine2/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n)]
...
def mpstatAllAvgPng(n):
  ...
  if os.path.exists(mpstat_csv_path):
    ...
    plt.xticks(ind, ('Container\nRandom\nmachine 2', 'Container\nSet\nmachine 2', 'Firecracker\nRandom\nmachine 2', 'Firecracker\nSet\nmachine 2'))#, rotation='vertical'
