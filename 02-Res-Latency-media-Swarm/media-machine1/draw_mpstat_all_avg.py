...
def mpstatAllAvg(n):
  filenames = ['Res-container-random-Swarm-v1-machine1/container_t_10_c_30_composeReviewServiceCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
              'Res-container-set-Swarm-v1-machine1/container_t_10_c_30_composeReviewServiceCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
              'Res-firecracker-random-Swarm-v1-machine1/firecracker_t_10_c_30_composeReviewServiceCore_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n), \
              'Res-firecracker-set-Swarm-v1-machine1/firecracker_t_10_c_30_composeReviewServiceCore_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n)]
