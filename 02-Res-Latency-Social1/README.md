...
## Overall CPU Excel
Can see the overall CPU utilization, throughtput, BW etc. in this excel [02 - Latency of SocialNetwork1](https://docs.google.com/spreadsheets/d/1cVVgBsQXYFdK8wWYeFSkCXTaK7Lk_UoXT8pRVRz7Vhw/edit#gid=0).

## Overall Cpu Utilization
Overall cpu utilization comparison,under the condition: t_10_c_30_frontCore_4_wrk_1, different -R, according to the data in the upper excel [02 - Latency of SocialNetwork1](https://docs.google.com/spreadsheets/d/1cVVgBsQXYFdK8wWYeFSkCXTaK7Lk_UoXT8pRVRz7Vhw/edit#gid=0)

![CPU_Utilization](CPU_Utilization_social1.png)

## Avg Latency
Avg Latency comparison,under the condition: t_10_c_30_frontCore_4_wrk_1, firrerent -R, according to the data in the upper excel [02 - Latency of SocialNetwork1](https://docs.google.com/spreadsheets/d/1cVVgBsQXYFdK8wWYeFSkCXTaK7Lk_UoXT8pRVRz7Vhw/edit#gid=0)
...
![Mpstat_UsrSysEtc_R1500_Social1](mpstat_UsrSysEtc-container-firecrackerSet-R-1500-Social1.jpg)
