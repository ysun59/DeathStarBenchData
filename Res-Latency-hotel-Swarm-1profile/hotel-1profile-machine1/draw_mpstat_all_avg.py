...
def mpstatAllAvg(n):
  # filenames = ['Res-container-random-v1/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
  #           'Res-container-set-v1/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
  #           'Res-firecracker-random-v1/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n), \
  #           'Res-firecracker-set-v1/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n)]

  filenames = ['Res-container-random-Swarm-v1-machine1/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-container-set-Swarm-v1-machine1/container_t_10_c_30_frontCore_4_wrkCore_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-firecracker-random-Swarm-v1-machine1/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n), \
            'Res-firecracker-set-Swarm-v1-machine1/firecracker_t_10_c_30_frontVcpu_4_wrkVcpu_1_R_{}/mpstat_all_Avg.txt'.format(n)]
...
def mpstatAllAvgPng(n):
  ...
  if os.path.exists(mpstat_csv_path):
    ...
    plt.cla() #清空坐标轴
    plt.title('mpstat Cpu utilization-all-avg R_{}_Swarm'.format(n))

    ind = np.arange(colNum)  #[ 0  1  2  3...31]
    # plt.xticks(ind, ('Container\nRandom', 'Container\nSet', 'Firecracker\nRandom', 'Firecracker\nSet'))#, rotation='vertical'
    plt.xticks(ind, ('Container\nRandom\nmachine 1', 'Container\nSet\nmachine 1', 'Firecracker\nRandom\nmachine 1', 'Firecracker\nSet\nmachine 1'))#, rotation='vertical'
...
mpstatAllAvgPng(1500)
mpstatAllAvgPng(2000)
mpstatAllAvgPng(2400)